...
# Configuration
SECRET_KEY = os.getenv("SECRET_KEY", "cyber_secret_key_fixed_change_in_prod")
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = 2880  # Increased to 48 hours for stable demo performance
