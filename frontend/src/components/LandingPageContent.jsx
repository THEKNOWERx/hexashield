      ...
      <nav className="border-b border-white/5 bg-cyber-black/40 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-10 text-[11px] font-semibold tracking-wide text-gray-400">
            <Link href="/nexus/tactical" className="hover:text-cyber-blue transition-colors">Features</Link>
            <Link href="/nexus/intelligence" className="hover:text-cyber-blue transition-colors">Platform</Link>
            <Link href="/nexus/protocol" className="hover:text-cyber-blue transition-colors">Documentation</Link>
          </div>
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          >
            <Link href="/login" className="cyber-button text-xs px-7 py-3">
              Sign in
            </Link>
          </motion.div>
        </div>
      ...
      <section className="relative pt-32 pb-20 px-6 z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-10">
            ...
            >
              <Link href="/login" className="cyber-button text-sm px-9 py-4 flex items-center justify-center gap-2.5 group">
                Get started
                <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/register" className="px-9 py-4 rounded-xl bg-white/[0.03] border border-white/[0.08] hover:border-cyber-blue/50 transition-all flex items-center justify-center text-sm font-semibold text-gray-300 hover:text-white">
                Create account
              </Link>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
           <div className="flex-1 space-y-8">
              ...
              <div className="flex gap-4">
                 <Link href="/url-scan" className="px-8 py-3.5 bg-cyber-neon text-black font-semibold text-sm rounded-xl hover:brightness-110 transition-all">
                    Audit a link
                 </Link>
