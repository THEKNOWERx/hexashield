...
// TODO: handle react-router-dom imports: useParams
      ...
      <div className="space-y-5">
        ...
        {(!vulnerabilities || vulnerabilities.length === 0) ? (
          <div className="py-32 text-center border border-dashed border-white/[0.08] rounded-2xl bg-white/[0.01]">
             ...
             <button onClick={() => router.push('/scan')} className="mt-6 px-6 py-2.5 bg-cyber-blue rounded-lg text-sm font-semibold text-white hover:bg-blue-600 transition-all">
                Start a scan
             </button>
          </div>
        ) : (
